(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('symbol-observable'), require('apollo-link'), require('apollo-link-dedup'), require('graphql/language/printer'), require('apollo-utilities')) :
    typeof define === 'function' && define.amd ? define(['exports', 'symbol-observable', 'apollo-link', 'apollo-link-dedup', 'graphql/language/printer', 'apollo-utilities'], factory) :
    (factory((global.apollo = global.apollo || {}, global.apollo.core = {}),global.$$observable,global.apolloLink.core,global.apolloLink.dedup,global.print,global.apollo.utilities));
}(this, (function (exports,$$observable,apolloLink,apolloLinkDedup,printer,apolloUtilities) { 'use strict';
