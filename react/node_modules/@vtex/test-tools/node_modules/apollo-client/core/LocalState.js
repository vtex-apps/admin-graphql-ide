...
var LocalState = (function () {
    ...
    LocalState.prototype.runResolvers = function (_a) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_c) {
                if (document) {
                    return [2, this.resolveDocument(document, remoteResult.data, context, variables, this.fragmentMatcher, onlyRunForcedResolvers).then(function (localResult) { return (tslib_1.__assign({}, remoteResult, { data: localResult.result })); })];
                }
    ...
    LocalState.prototype.clientQuery = function (document) {
        if (apollo_utilities_1.hasDirectives(['client'], document)) {
            ...
            ts_invariant_1.invariant.warn('Found @client directives in query but no client resolvers were specified. ' +
    ...
    LocalState.prototype.prepareContext = function (context) {
        ...
        var newContext = tslib_1.__assign({}, context, { cache: cache, getCacheKey: function (obj) {
                if (cache.config) {
    ...
    LocalState.prototype.addExportedVariables = function (document, variables, context) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                if (document) {
                    return [2, this.resolveDocument(document, this.buildRootValueFromCache(document, variables) || {}, this.prepareContext(context), variables).then(function (data) { return (tslib_1.__assign({}, variables, data.exportedVariables)); })];
                }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                ...
                execContext = {
                    ...
                    context: tslib_1.__assign({}, context, { cache: cache,
                        client: client }),
                    variables: variables,
