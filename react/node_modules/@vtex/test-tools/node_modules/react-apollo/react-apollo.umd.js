(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prop-types'), require('ts-invariant'), require('tslib'), require('react'), require('apollo-client'), require('hoist-non-react-statics')) :
    typeof define === 'function' && define.amd ? define(['exports', 'prop-types', 'ts-invariant', 'tslib', 'react', 'apollo-client', 'hoist-non-react-statics'], factory) :
    (global = global || self, factory(global['react-apollo'] = {}, global.propTypes, global.invariant, global.tslib, global.react, global.apollo.core, global.hoistNonReactStatics));
}(this, function (exports, propTypes, tsInvariant, tslib, react, apolloClient, hoistNonReactStatics) { 'use strict';
