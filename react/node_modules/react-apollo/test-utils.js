(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apollo-cache-inmemory'), require('apollo-client'), require('prop-types'), require('react'), require('apollo-link'), require('graphql/language/printer'), require('apollo-utilities')) :
    typeof define === 'function' && define.amd ? define(['exports', 'apollo-cache-inmemory', 'apollo-client', 'prop-types', 'react', 'apollo-link', 'graphql/language/printer', 'apollo-utilities'], factory) :
    (factory((global['react-apollo'] = {}),global.apolloCacheInmemory,global.ApolloClient,global.PropTypes,global.React,global.apolloLink,global.printer,global.apolloUtilities));
}(this, (function (exports,apolloCacheInmemory,ApolloClient,PropTypes,React,apolloLink,printer,apolloUtilities) { 'use strict';
